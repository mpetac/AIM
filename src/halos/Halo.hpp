...
public:
    ...
    virtual std::complex<double> v_phi(std::complex<double> R2, std::complex<double> z2) = 0;
    
    /// Computes the first derivative of halo's mean rotation around the z-axis with respect to z2
    virtual std::complex<double> v_phi_dz2(std::complex<double> R2, std::complex<double> z2) = 0;
    
    /// Computes the second derivative of halo's mean rotation around the z-axis with respect to z2
    virtual std::complex<double> v_phi_d2z2(std::complex<double> R2, std::complex<double> z2) = 0;
