...
std::complex<double> Halo_NFW::v_phi(std::complex<double> R2, std::complex<double> z2) {
    return Parametric_funcs::v_phi(R2, z2, Halo_NFW::halo_rot);
}
...
std::complex<double> Halo_NFW::v_phi_dz2(std::complex<double> R2, std::complex<double> z2) {
    return Parametric_funcs::v_phi_dz2(R2, z2, Halo_NFW::halo_rot);
}
...
std::complex<double> Halo_NFW::v_phi_d2z2(std::complex<double> R2, std::complex<double> z2) {
    return Parametric_funcs::v_phi_d2z2(R2, z2, Halo_NFW::halo_rot);
}
